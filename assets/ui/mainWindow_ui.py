...
"")
        ...
        self.widget_108 = QtWidgets.QWidget(parent=self.widget_26)
...
"")
        ...
        self.horizontalLayout_13.addWidget(self.widget_108)
        self.verticalLayout_20.addWidget(self.widget_26)
        self.verticalLayout_13.addWidget(self.widget_34)
        self.widget_86 = QtWidgets.QWidget(parent=self.widget_23)
...
"border-radius: 10px;")
        ...
        self.verticalLayout_13.addWidget(self.widget_86)
...
"")
        ...
        self.widget_68.setMinimumSize(QtCore.QSize(0, 150))
...
"")
        ...
        self.verticalLayout_25.addWidget(self.widget_70, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        self.progressBar_vulnerScan = QtWidgets.QProgressBar(parent=self.widget_68)
...
"}     ")
        ...
        self.verticalLayout_25.addWidget(self.progressBar_vulnerScan, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignTop)
        ...
        self.widget_66.setMinimumSize(QtCore.QSize(0, 0))
        ...
        self.widget_112.setMinimumSize(QtCore.QSize(0, 350))
...
"}")
        ...
        self.widget_22 = QtWidgets.QWidget(parent=self.widget_64)
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(12)
        font.setBold(True)
...
"")
        ...
        self.horizontalLayout_73 = QtWidgets.QHBoxLayout(self.widget_22)
        self.horizontalLayout_73.setObjectName("horizontalLayout_73")
        self.btn_createReportVulner = QtWidgets.QPushButton(parent=self.widget_22)
        self.btn_createReportVulner.setMinimumSize(QtCore.QSize(130, 40))
        self.btn_createReportVulner.setMaximumSize(QtCore.QSize(130, 40))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift SemiBold")
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.horizontalLayout_73.addWidget(self.btn_createReportVulner)
        self.verticalLayout_37.addWidget(self.widget_22, 0, QtCore.Qt.AlignmentFlag.AlignRight)
...
"")
        ...
        self.verticalLayout_45.addWidget(self.widget_77, 0, QtCore.Qt.AlignmentFlag.AlignHCenter|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.widget_134 = QtWidgets.QWidget(parent=self.widget_75)
        self.widget_134.setMinimumSize(QtCore.QSize(0, 400))
        ...
        self.btn_createReportHttps = QtWidgets.QPushButton(parent=self.widget_75)
...
"")
        ...
        self.verticalLayout_45.addWidget(self.btn_createReportHttps, 0, QtCore.Qt.AlignmentFlag.AlignRight)
...
"")
        ...
        self.widget_131 = QtWidgets.QWidget(parent=self.widget_130)
        self.widget_131.setObjectName("widget_131")
        self.verticalLayout_77 = QtWidgets.QVBoxLayout(self.widget_131)
        self.verticalLayout_77.setContentsMargins(-1, 11, -1, 11)
        self.verticalLayout_77.setObjectName("verticalLayout_77")
        self.widget_133 = QtWidgets.QWidget(parent=self.widget_131)
        self.widget_133.setObjectName("widget_133")
        self.verticalLayout_78 = QtWidgets.QVBoxLayout(self.widget_133)
        self.verticalLayout_78.setContentsMargins(-1, -1, -1, 11)
        self.verticalLayout_78.setObjectName("verticalLayout_78")
        self.widget_135 = QtWidgets.QWidget(parent=self.widget_133)
...
"")
        ...
        self.verticalLayout_78.addWidget(self.widget_135)
        self.verticalLayout_77.addWidget(self.widget_133, 0, QtCore.Qt.AlignmentFlag.AlignTop)
        self.widget_129 = QtWidgets.QWidget(parent=self.widget_131)
...
"")
        ...
        self.verticalLayout_77.addWidget(self.widget_129)
        self.widget_164 = QtWidgets.QWidget(parent=self.widget_131)
